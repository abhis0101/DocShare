                ...
                <div>
                    <form id="form1" runat="server">
                        ...
                        <div class="flex relative mb-5">
                            ...
                            <asp:TextBox ID="textname" runat="server" required="" class="rounded-r-md flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white shadow-sm text-base outline-none" placeholder="Enter your Name" value="" Style="color: rgb(90, 113, 157)"></asp:TextBox>
                        ...
                        <div class="flex relative mb-5">
                            ...
                            <asp:TextBox ID="txtemail" runat="server" required="" type="text" class="rounded-r-md flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white shadow-sm text-base outline-none" placeholder="Enter your email" value="" Style="color: rgb(90, 113, 157)"></asp:TextBox>
                        </div>
                        <div class="flex relative mb-5">
                            <span class="rounded-l-md inline-flex items-center px-3 border-t bg-white border-l border-b border-gray-300 text-gray-500 shadow-sm text-sm" style="color: rgb(31, 75, 153)">
                            ...
                            <asp:TextBox ID="txtmobile" runat="server" required="" class="rounded-r-md flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white shadow-sm text-base outline-none" placeholder="Enter your Mobile no." value="" Style="color: rgb(90, 113, 157)"></asp:TextBox>
                        ...
                        <div class="flex relative mb-5">
                            ...
                            <asp:TextBox ID="txtpassword" TextMode="Password" runat="server" required="" class="rounded-r-md flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white shadow-sm text-base outline-none" placeholder="Enter your Password" value="" Style="color: rgb(90, 113, 157)"></asp:TextBox>
                        ...
                        <div class="flex relative">
                            ...
                            <asp:TextBox ID="txtconpassword" TextMode="Password" runat="server" required="" class="rounded-r-md flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white shadow-sm text-base outline-none" placeholder="Enter your Confirm Password" value="" Style="color: rgb(90, 113, 157)"></asp:TextBox>
