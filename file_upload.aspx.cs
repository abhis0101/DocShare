    ...
    public partial class file_upload : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            foreach (HttpPostedFile postedFile in FileUpload1.PostedFiles)
            {
                ...
                string Query = "insert into file_details(imgname,imgpath,usercode,date1,month1,folderid) values('" + fileName + "','" + output + "','" + Session["usercode"].ToString() + "','" + date + "','" + month + "','" + folder_id + "')";
