                        ...
                        <div class="p-4 mt-5">
                            ...
                            <div class="infobox hidden absolute top-[60%] left-[34%] z-10 bg-white shadow-lg" id='<%# Eval("id") %>'>
                                <ul class="w-full">
                                    ...
                                    <li class="p-2 hover:bg-gray-300 transiton-all text-lg"><a href="download.aspx?filename=<%# Eval("imgname") %>">Download</a></li>
                                    <li class="p-2 hover:bg-gray-300 transiton-all text-lg"><a href="#" onclick="DownloadFile1('<%# Eval("imgname") %>')">Download Image</a></li>
